      ...
      <div className="md:hidden flex items-center justify-between gap-2 px-1">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <button
            ...
            className="px-3 py-1.5 rounded-full bg-amber-500 hover:bg-amber-400 text-slate-950 font-extrabold text-xs shadow-md flex items-center gap-1 active:scale-95 transition-transform cursor-pointer"
          >
          ...
          {loading ? (
            ...
            <div className="flex items-center gap-1.5 bg-white/85 dark:bg-slate-900/85 backdrop-blur-xl p-1 rounded-full border border-white/80 dark:border-white/20 shadow-md">
              ...
              {favorites.length > 0 && (
                <span className="text-[10px] font-bold text-amber-600 dark:text-amber-400 pr-1.5 flex items-center gap-0.5">
            ...
            <button
              onClick={signIn}
              className="p-2 rounded-full bg-slate-900 text-white shadow-md active:scale-95 transition-transform cursor-pointer"
